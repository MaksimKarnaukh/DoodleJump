...
public:
         ...
         */
        virtual void setBonusForce(const float force) { bonusForce = force; }
         ...
         */
        virtual void setScoreIncrease(const float inc) { scoreIncrease = inc; }
         ...
         */
        virtual float getBonusForce() const { return bonusForce; };
         ...
         */
        virtual float getScoreIncrease() const { return scoreIncrease; }
