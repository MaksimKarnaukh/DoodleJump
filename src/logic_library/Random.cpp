...
Random::Random() { randomEngine = std::mt19937(rd()); };
...
{
        std::piecewise_constant_distribution<float> piecew_const_dist(&intervals[0], &intervals[0] + intervals.size(),
                                                                      &densities[0]);
...
{
        std::piecewise_constant_distribution<float> piecew_lin_dist(&intervals[0], &intervals[0] + intervals.size(),
                                                                    &densities[0]);
