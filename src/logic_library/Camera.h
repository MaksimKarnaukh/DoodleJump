...
class Camera
{
        ...
        float shiftValue =
            0.0f; // value that indicates how much we need to decrease our y-coordinate to project near the origin.
...
public:
         ...
         */
        void setShiftValue(float shift) { shiftValue = shift; }
         ...
         */
        void setLeftBound(const float LeftBound) { leftBound = LeftBound; }
         ...
         */
        void setRightBound(const float RightBound) { rightBound = RightBound; }
         ...
         */
        void setLowerBound(const float LowerBound) { lowerBound = LowerBound; }
         ...
         */
        void setShiftBorder(const float ShiftBorder) { shiftBorder = ShiftBorder; }
         ...
         */
        float getShiftValue() const { return shiftValue; }
         ...
         */
        float getLeftBound() const { return leftBound; }
         ...
         */
        float getRightBound() const { return rightBound; }
         ...
         */
        float getShiftBorder() const { return shiftBorder; }
