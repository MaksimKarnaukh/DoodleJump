...
public: // getters en setters
         ...
         */
        void setWidth(float width) { e_width = width; }
         ...
         */
        void setHeight(float height) { e_height = height; }
         ...
         */
        void setPositionX(float posX) { x_pos = posX; }
         ...
         */
        void setPositionY(float posY) { y_pos = posY; }
         ...
         */
        void setPreviousPositionX(float posX) { x_posPrevious = posX; }
         ...
         */
        void setPreviousPositionY(float posY) { y_posPrevious = posY; }
         ...
         */
        void setUnitOfDistance(float unitOfDistance) { unit = unitOfDistance; }
         ...
         */
        float getWidth() const { return e_width; }
         ...
         */
        float getHeight() const { return e_height; }
         ...
         */
        float getPositionX() const { return x_pos; }
         ...
         */
        float getPositionY() const { return y_pos; }
         ...
         */
        float getPreviousPositionX() const { return x_posPrevious; }
         ...
         */
        float getPreviousPositionY() const { return y_posPrevious; }
...
public:
         ...
         */
        EntityModel(float posX, float posY);
         ...
         */
        EntityModel(float posX, float posY, float width, float height);

        /**
         * @function : EntityModel
         * Destructor for a EntityModel.
         */
