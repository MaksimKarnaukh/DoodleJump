...
public:
         ...
         */
        std::shared_ptr<logic::Platform> createStaticPlatform(float posX, float posY, float width,
         ...
         * @return (std::shared_ptr<logic::Platform>) : platform model.
         */
        std::shared_ptr<logic::Platform> createTemporaryPlatform(float posX, float posY, float width,
                                                                 float height) override;
         ...
         * @return (std::shared_ptr<logic::Platform>) : platform model.
         */
        std::shared_ptr<logic::Platform> createHorizontalPlatform(float posX, float posY, float width,
                                                                  float height) override;
         ...
         * @return (std::shared_ptr<logic::Platform>) : platform model.
         */
        std::shared_ptr<logic::Platform> createVerticalPlatform(float posX, float posY, float width,
                                                                float height) override;
