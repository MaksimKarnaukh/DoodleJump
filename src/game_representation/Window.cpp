...
Window::Window() { Setup("Doodle Jump", sf::Vector2u(640, 960)); }
...
void Window::Create() { m_window.create({m_windowSize.x, m_windowSize.y, 32}, m_windowTitle); }
                ...
                if (event.type == sf::Event::LostFocus ||
                    event.type == sf::Event::KeyPressed && event.key.code == sf::Keyboard::Escape) {
                        ...
                        while (true) {
                                ...
                                if (m_window.pollEvent(event1) &&
                                    (event1.type == sf::Event::GainedFocus ||
