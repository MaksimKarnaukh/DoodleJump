...
public:
        ...
        public:
                ...
                enum Status
                {
                        ...
                        SystemType = 215, ///< NAME system type, where NAME is an official system name from the list in
                        ...
                        ConnectionFailed = 1001, ///< Not part of the FTP standard, generated by SFML when the low-level
                                                 ///< socket connection with the server fails
                        ConnectionClosed = 1002, ///< Not part of the FTP standard, generated by SFML when the low-level
                                                 ///< socket connection is unexpectedly closed
                        InvalidFile = 1003 ///< Not part of the FTP standard, generated by SFML when a local file cannot
                                           ///< be read or written
                };
