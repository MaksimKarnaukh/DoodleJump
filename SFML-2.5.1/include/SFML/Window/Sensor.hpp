...
public:
        ...
        enum Type
        {
                ...
                Gravity,       ///< Measures the direction and intensity of gravity, independent of device acceleration
                               ///< (m/s^2)
...
/// both the earth gravity and the user_ movement. The others are
