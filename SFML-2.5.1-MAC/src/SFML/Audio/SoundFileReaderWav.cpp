...
bool decode(sf::InputStream& stream, sf::Uint8& value) { return stream.read(&value, sizeof(value)) == sizeof(value); }
...
////////////////////////////////////////////////////////////
SoundFileReaderWav::SoundFileReaderWav() : m_stream(NULL), m_bytesPerSample(0), m_dataStart(0), m_dataEnd(0) {}
