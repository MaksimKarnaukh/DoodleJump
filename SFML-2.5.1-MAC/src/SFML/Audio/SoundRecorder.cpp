...
SoundRecorder::SoundRecorder()
    : m_thread(&SoundRecorder::record, this), m_sampleRate(0), m_processingInterval(milliseconds(100)),
      m_isCapturing(false), m_deviceName(getDefaultDevice()), m_channelCount(1)
{
}
...
SoundRecorder::~SoundRecorder()
{
        ...
        assert(!m_isCapturing && "You must call stop() in the destructor of your derived class, so that the recording "
...
////////////////////////////////////////////////////////////
unsigned int SoundRecorder::getSampleRate() const { return m_sampleRate; }
...
////////////////////////////////////////////////////////////
std::string SoundRecorder::getDefaultDevice() { return alcGetString(NULL, ALC_CAPTURE_DEFAULT_DEVICE_SPECIFIER); }
...
////////////////////////////////////////////////////////////
const std::string& SoundRecorder::getDevice() const { return m_deviceName; }
...
////////////////////////////////////////////////////////////
unsigned int SoundRecorder::getChannelCount() const { return m_channelCount; }
...
////////////////////////////////////////////////////////////
void SoundRecorder::setProcessingInterval(Time interval) { m_processingInterval = interval; }
