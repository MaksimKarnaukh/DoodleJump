...
////////////////////////////////////////////////////////////
bool VertexBuffer::update(const Vertex* vertices) { return update(vertices, m_size, 0); }
...
bool VertexBuffer::update(const Vertex* vertices, std::size_t vertexCount, unsigned int offset)
{
        ...
        glCheck(GLEXT_glBufferSubData(GLEXT_GL_ARRAY_BUFFER, sizeof(Vertex) * offset, sizeof(Vertex) * vertexCount,
                                      vertices));
...
bool VertexBuffer::update(const VertexBuffer& vertexBuffer)
{
        ...
        if (GLEXT_copy_buffer) {
                ...
                glCheck(GLEXT_glCopyBufferSubData(GLEXT_GL_COPY_READ_BUFFER, GLEXT_GL_COPY_WRITE_BUFFER, 0, 0,
...
////////////////////////////////////////////////////////////
void VertexBuffer::setPrimitiveType(PrimitiveType type) { m_primitiveType = type; }
