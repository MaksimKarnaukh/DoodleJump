...
////////////////////////////////////////////////////////////
Vector2u WindowImplAndroid::getSize() const { return m_size; }
...
////////////////////////////////////////////////////////////
bool WindowImplAndroid::hasFocus() const { return m_hasFocus; }
...
int WindowImplAndroid::processScrollEvent(AInputEvent* _event, ActivityStates* states)
{
        ...
        jmethodID StaticMethodObtain =
            lJNIEnv->GetStaticMethodID(ClassMotionEvent, "obtain", "(JJIFFFFIFFII)Landroid/view/MotionEvent;");
        jobject ObjectMotionEvent =
            lJNIEnv->CallStaticObjectMethod(ClassMotionEvent, StaticMethodObtain, downTime, eventTime, action, x, y,
                                            pressure, size, metaState, xPrecision, yPrecision, deviceId, edgeFlags);
...
int WindowImplAndroid::getUnicode(AInputEvent* event)
{
        ...
        jobject ObjectKeyEvent = lJNIEnv->NewObject(ClassKeyEvent, KeyEventConstructor, downTime, eventTime, action,
                                                    code, repeat, metaState, deviceId, scancode, flags, source);
