...
bool CursorImpl::loadFromPixels(const Uint8* pixels, Vector2u size, Vector2u hotspot)
{
        ...
        Pixmap maskPixmap =
            XCreateBitmapFromData(m_display, XDefaultRootWindow(m_display), (char*)&mask[0], size.x, size.y);
        Pixmap dataPixmap =
            XCreateBitmapFromData(m_display, XDefaultRootWindow(m_display), (char*)&data[0], size.x, size.y);
