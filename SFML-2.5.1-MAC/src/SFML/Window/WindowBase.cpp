...
////////////////////////////////////////////////////////////
WindowBase::WindowBase(WindowHandle handle) : m_impl(NULL), m_size(0, 0) { WindowBase::create(handle); }
...
////////////////////////////////////////////////////////////
Vector2i WindowBase::getPosition() const { return m_impl ? m_impl->getPosition() : Vector2i(); }
...
////////////////////////////////////////////////////////////
WindowHandle WindowBase::getSystemHandle() const { return m_impl ? m_impl->getSystemHandle() : 0; }
...
////////////////////////////////////////////////////////////
const WindowBase* WindowBase::getFullscreenWindow() { return fullscreenWindow; }

////////////////////////////////////////////////////////////
void WindowBase::setFullscreenWindow(const WindowBase* window) { fullscreenWindow = window; }
